...
import CleanScratchableCard from "./clean-scratchable-card"
      ...
      <div className="container relative z-20 px-4 md:px-6 mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen py-8 lg:py-16 gap-8 lg:gap-12">
          ...
          >
            ...
            >
              Descubra uma nova forma de se conectar com seu parceiro
              através de desafios, conversas e atividades especiais
              desenvolvidas para casais
            </motion.p>
            {/* Features List */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
          ...
          {/* Right Content - Clean Scratchable Card */}
          <motion.div
