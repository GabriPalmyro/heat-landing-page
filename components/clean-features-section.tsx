...
export default function CleanFeaturesSection() {
  ...
  const features = [
    ...
    {
      icon: <MessageCircle className="h-10 w-10 text-[#FF1D3E]" />,
      title: "Conversas Profundas",
      description: "Perguntas e tópicos especiais para conhecer melhor seu parceiro.",
    },
    {
      icon: <Sparkles className="h-10 w-10 text-[#FF1D3E]" />,
      title: "Atividades Exclusivas",
    ...
    <section id="features" ref={ref} className="relative w-full py-20 bg-gradient-to-b from-black via-gray-900 to-black">
      ...
      <div className="container relative z-10 px-4 md:px-6 mx-auto">
        <div className="text-center mb-12">
          ...
          >
            Descubra o que torna o Heat o melhor aplicativo para casais
          </motion.p>
        </div>
